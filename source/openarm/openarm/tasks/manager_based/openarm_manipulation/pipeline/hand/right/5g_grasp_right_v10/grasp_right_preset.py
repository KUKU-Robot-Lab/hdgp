...
# rj_dg_1_1 = 0.0 고정 (v10: -0.354 → 0.0)
HAND_GRASP_POSE = [
    +0.000, -1.551, +0.130, +0.988,   # thumb  (v10: rj_dg_1_1 -0.354→0.0 고정)
...
# rj_dg_1_1 = 0.0 고정 (v10: -0.300 → 0.0)
HAND_FULL_GRIP_POSE = [
    +0.000, -2.500, +0.200, +1.500,   # thumb:  rj_dg_1_1=0.0 고정, curl 깊게 (-2.5)
