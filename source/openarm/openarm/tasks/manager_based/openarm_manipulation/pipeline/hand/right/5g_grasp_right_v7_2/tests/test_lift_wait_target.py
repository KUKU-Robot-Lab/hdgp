...
SPEC = importlib.util.spec_from_file_location("grasp_right_utils", MODULE_PATH)
...
compute_joint7_lift_wait_target = grasp_right_utils.compute_joint7_lift_wait_target
