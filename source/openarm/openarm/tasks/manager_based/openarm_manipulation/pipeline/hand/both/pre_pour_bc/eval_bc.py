...
try:
    ...
    _sys.path.insert(0, str(_pkg_file.parents[8]))
    from openarm.tasks.manager_based.openarm_manipulation.pipeline.hand.both import pre_pour_bc as _task
    from openarm.tasks.manager_based.openarm_manipulation.pipeline.hand.both.pre_pour_bc import PrePourBCPlayEnvCfg
    from openarm.tasks.manager_based.openarm_manipulation.pipeline.hand.both.pre_pour_bc.train_bc_rnn import (
        BCRNN,
        DEFAULT_CHECKPOINT,
    )
