"""Fabrics-based right arm + right hand ActionTerm for pre_pour_bc.
...
from .pre_pour_bc_math import RIGHT_PALM_DELTA_ROT_SCALE, RIGHT_PALM_DELTA_XYZ_SCALE
...
class FabricsRightArmActionTerm(ActionTerm):
    ...
    def __init__(self, cfg: FabricsRightArmActionTermCfg, env: "ManagerBasedEnv") -> None:
        ...
        # ---------------- Fabrics setup ----------------
        initialize_warp("pre_pour_bc_action")
