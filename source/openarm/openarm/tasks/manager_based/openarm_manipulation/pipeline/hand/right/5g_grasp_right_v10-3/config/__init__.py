...
gym.register(
    id="5g_grasp_right-v10-3",
    entry_point=(
        "openarm.tasks.manager_based.openarm_manipulation"
        ".pipeline.hand.right.5g_grasp_right_v10-3"
...
gym.register(
    id="5g_grasp_right-play-v10-3-lstm",
    entry_point=(
        "openarm.tasks.manager_based.openarm_manipulation"
        ".pipeline.hand.right.5g_grasp_right_v10-3"
        ".grasp_right_env:GraspRightEnv"
