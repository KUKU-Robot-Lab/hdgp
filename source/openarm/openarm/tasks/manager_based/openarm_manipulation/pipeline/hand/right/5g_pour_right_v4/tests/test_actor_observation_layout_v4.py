...
def test_v4_lstm_actor_uses_pour_flow_observation_contract() -> None:
...
def test_v4_lstm_config_encodes_then_recurrs() -> None:
...
def test_v4_real_demo_bc_buffer_matches_actor_observation_contract() -> None:
