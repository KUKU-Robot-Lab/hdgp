...
class GraspLeftEnvCfg(DirectRLEnvCfg):
    ...
    pregrasp_offset_y:     float = 0.07   # y 대칭: right -0.07 → left +0.07
    ...
    # left: workspace +y 대칭 → goal y = +0.10 (right -0.10).
    # -----------------------------------------------------------------------
    ...
    obj_out_y_min:  float = -0.25   # y 대칭: right [-0.60,0.25] → left [-0.25,0.60]
    ...
    object_spawn_y_center: float = 0.10   # y 대칭: right -0.10 → left +0.10
    ...
    robot_cfg: ArticulationCfg = ArticulationCfg(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            ...
            rot=[1.0, 0.0, 0.0, 0.0],
            joint_pos={
                # 제어 왼팔: LEFT_ARM_START_POSE 미러 = [-0.5,-0.1,-0.4,0.60,0.2,0,0]
                "l_aj_1": -0.5,
                "l_aj_2": -0.1,
                "l_aj_3": -0.4,
                "l_aj_4":  0.60,
