...
class GraspRightEnvCfg(DirectRLEnvCfg):
    ...
    # Reward 파라미터
    # -----------------------------------------------------------------------
    # Reach v1 Coarse-to-Fine 및 정렬 보상 파라미터
    approach_coarse_weight: float = 0.25
    approach_fine_weight: float = 0.20
    approach_fine_std: float = 0.10
    approach_align_weight: float = 0.10
