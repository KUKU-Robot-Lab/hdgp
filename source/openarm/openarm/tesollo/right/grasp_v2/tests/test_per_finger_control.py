...
from openarm.tesollo.right.grasp_v2.finger_action_utils import (
...
def test_synergy_cannot_represent_pinky_only_grasp():
    ...
    """
    from openarm.tesollo.right.grasp_v2.tesollo_hand_synergy import HAND_SYNERGY_BASIS
...
def test_shape_and_dtype_match_synergy_path():
    ...
    from openarm.tesollo.right.grasp_v2.tesollo_hand_synergy import (
        HAND_SYNERGY_ANCHOR,
        HAND_SYNERGY_BASIS,
        HAND_SYNERGY_COEFF_MAXS,
        HAND_SYNERGY_COEFF_MINS,
    )
    from openarm.tesollo.right.grasp_v2.grasp_right_preset import (
        HAND_APPROACH_POSE,
        HAND_FULL_GRIP_POSE,
    )
