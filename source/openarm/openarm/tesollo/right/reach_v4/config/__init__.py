...
gym.register(
    id="open-tesol_r_reach_v4",
    entry_point=(
        "openarm.tesollo.right.reach_v4.grasp_right_env:GraspRightEnv"
    ),
...
gym.register(
    id="open-tesol_r_reach_v4-play-lstm",
    entry_point=(
        "openarm.tesollo.right.reach_v4.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
