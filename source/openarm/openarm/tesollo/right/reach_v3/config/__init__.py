...
gym.register(
    id="open-tesol_r_reach_v3",
    entry_point=(
        "openarm.tesollo.right.reach_v3.grasp_right_env:GraspRightEnv"
    ),
...
gym.register(
    id="open-tesol_r_reach_v3-play-lstm",
    entry_point=(
        "openarm.tesollo.right.reach_v3.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
