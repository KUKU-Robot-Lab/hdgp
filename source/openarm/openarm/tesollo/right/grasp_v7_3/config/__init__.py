...
gym.register(
    id="open-tesol_r_grasp_v7_3",
    entry_point=(
        "openarm.tesollo.right.grasp_v7_3.grasp_right_env:GraspRightEnv"
    ),
...
gym.register(
    id="open-tesol_r_grasp_v7_3-lstm",
    entry_point=(
        "openarm.tesollo.right.grasp_v7_3.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
...
gym.register(
    id="open-tesol_r_grasp_v7_3-play",
    entry_point=(
        "openarm.tesollo.right.grasp_v7_3.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
...
gym.register(
    id="open-tesol_r_grasp_v7_3-play-lstm",
    entry_point=(
        "openarm.tesollo.right.grasp_v7_3.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
