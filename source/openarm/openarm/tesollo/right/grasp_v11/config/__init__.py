...
gym.register(
    id="open-tesol_r_grasp_v11",
    entry_point=(
        "openarm.tesollo.right.grasp_v11.grasp_right_env:GraspRightEnv"
    ),
...
gym.register(
    id="open-tesol_r_grasp_v11-lstm",
    entry_point=(
        "openarm.tesollo.right.grasp_v11.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
...
gym.register(
    id="open-tesol_r_grasp_v11-play",
    entry_point=(
        "openarm.tesollo.right.grasp_v11.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
...
gym.register(
    id="open-tesol_r_grasp_v11-play-lstm",
    entry_point=(
        "openarm.tesollo.right.grasp_v11.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
