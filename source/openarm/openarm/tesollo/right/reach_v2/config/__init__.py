...
gym.register(
    id="open-tesol_r_reach_v2",
    entry_point=(
        "openarm.tesollo.right.reach_v2.grasp_right_env:GraspRightEnv"
    ),
...
gym.register(
    id="open-tesol_r_reach_v2-play-lstm",
    entry_point=(
        "openarm.tesollo.right.reach_v2.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
