...
gym.register(
    id="open-tesol_r_pour_v3",
    entry_point=(
        "openarm.tesollo.right.pour_v3.pour_right_env:PourRightEnv"
    ),
...
gym.register(
    id="open-tesol_r_pour_v3-play-lstm",
    entry_point=(
        "openarm.tesollo.right.pour_v3.pour_right_env:PourRightEnv"
    ),
    disable_env_checker=True,
