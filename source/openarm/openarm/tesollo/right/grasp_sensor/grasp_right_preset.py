...
# ★08.18 grasp_sensor: 자산 = openarm_tesollo_sensor_rl — 좌측은 2-DOF 프리즈매틱
...
LEFT_ARM_REST_JOINT_POS = {
    ...
    # ★08.18 sensor_rl(DG-5F) 실측 갱신: grasp_sensor 첫 부팅에서 _build_home_pose 가
    #   출력한 미러값(q_home=[+0.0431,+0.6706,+0.0961,+0.7342,+0.3750,+0.5678,+0.6709]).
    #   bi_s_rl 값([-0.3082,-0.5785,...])과 최대 0.265rad 어긋났다 — palm 오프셋
    #   (+5.5cm) 차이로 같은 홈 palm 목표의 IK 해가 다르게 풀린 것(추정 아님, 실측).
    "l_aj_1": -0.0431,
    "l_aj_2": -0.6706,
    "l_aj_3": -0.0961,
    "l_aj_4": +0.7342,
