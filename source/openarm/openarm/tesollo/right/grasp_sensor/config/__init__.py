...
gym.register(
    id="open-tesol_r_grasp_sensor",
    entry_point=(
        "openarm.tesollo.right.grasp_sensor.grasp_right_env:GraspRightEnv"
    ),
...
gym.register(
    id="open-tesol_r_grasp_sensor-play",
    entry_point=(
        "openarm.tesollo.right.grasp_sensor.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
...
gym.register(
    id="open-tesol_r_grasp_sensor-lstm",
    entry_point=(
        "openarm.tesollo.right.grasp_sensor.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
...
gym.register(
    id="open-tesol_r_grasp_sensor-play-lstm",
    entry_point=(
        "openarm.tesollo.right.grasp_sensor.grasp_right_env:GraspRightEnv"
    ),
    disable_env_checker=True,
