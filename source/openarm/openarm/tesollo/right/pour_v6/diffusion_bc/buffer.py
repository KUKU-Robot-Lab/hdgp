...
Obs 52D:
  ...
  [43:46] right_cup_pos_rel   (source_cup_pos - right_palm_pos)
...
def _load_episode_fk(
    ...
    # a11-a20 source_cup pos는 더미(고정값)이지만 obs layout 일관성을 위해 사용
    src_cup_pos = src_cup[:, :3, 3]                                      # (T, 3)
    right_cup_pos_rel = src_cup_pos - r_palm_pos                         # (T, 3)
