...
gym.register(
    id="open-tesol_r_pour_v5",
    entry_point=(
        "openarm.tesollo.right.pour_v5.pour_right_env:PourRightEnv"
    ),
...
gym.register(
    id="open-tesol_r_pour_v5-play-lstm",
    entry_point=(
        "openarm.tesollo.right.pour_v5.pour_right_env:PourRightEnv"
    ),
    disable_env_checker=True,
