...
# entry_point 모듈 경로 (현재 위치: pipeline.hand.inspire_r.pour_r_v1)
_ENTRY = (
    "openarm.rh56f1.right.pour_v1.pour_right_env:PourRightEnv"
)
...
gym.register(
    id="open-rh56f1_r_pour_v1-play-lstm",
    entry_point=_ENTRY,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}:PourRightEnvCfg_PLAY",
