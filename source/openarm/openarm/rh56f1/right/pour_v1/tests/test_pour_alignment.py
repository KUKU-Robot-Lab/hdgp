"""pour_point/corridor reward structure tests (RH56F1 이식본).
...
RH56F1 adaptation:
  - import from openarm.rh56f1.right.pour_v1.pour_right_utils
  - r_pour line uses multi-line form: "r_pour = pour_bead_w * corridor_score * ("
"""
...
from openarm.rh56f1.right.pour_v1.pour_right_utils import pour_alignment_score, pour_corridor_score
...
def test_outcome_adr_curriculum() -> None:
    ...
    # RH56F1: multi-line r_pour — check opening of expression
