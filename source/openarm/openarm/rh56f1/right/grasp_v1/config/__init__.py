...
# entry_point 모듈 경로 (grasp_v1 = DEXTRAH 구조, tesollo grasp_v1 매칭 / RH56F1 6-DOF 손).
_ENTRY = (
    "openarm.rh56f1.right.grasp_v1.grasp_right_env:GraspRightEnv"
)
...
gym.register(
    id="open-rh56f1_r_grasp_v1-play",
    entry_point=_ENTRY,
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="open-rh56f1_r_grasp_v1-lstm",
    entry_point=_ENTRY,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}:GraspRightEnvCfg",
...
gym.register(
    id="open-rh56f1_r_grasp_v1-play-lstm",
    entry_point=_ENTRY,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}:GraspRightEnvCfg_PLAY",
...
gym.register(
    id="open-rh56f1_r_grasp_v1-distill",
    entry_point=_ENTRY,
    disable_env_checker=True,
    kwargs={
