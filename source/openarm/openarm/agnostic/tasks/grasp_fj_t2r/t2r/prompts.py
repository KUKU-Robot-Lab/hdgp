...
VARIANTS: dict[str, EnvFacts] = {
    ...
    "reach": EnvFacts(
        scene=("+x points from the robot toward the table. Each episode starts with the arm raised beside the "
               ...
               "pose as the raised start, with the palm about 4.5 cm from the cup's side, the cup axis about "
               "cup_radius + 2.5 cm ahead of the palm centre along the fingers, and the palm centre in the upper part "
