...
class GraspFJT2RRandEnvCfg(GraspFJT2RReachEnvCfg):
    ...
    #: 상판 홈 (cx, cy, r) — env_v1 collision 메시에 (0.135, 0.0) 중심 지름 ~6 cm · 깊이 1 cm 오목부(z 0.195–0.205). 컵 바닥 원(outer_radius)이
    #:   r = 0.03 + 여유 0.005 원과 겹치면 버린다(프로브에서 x 0.15–0.25 · y −0.05–0.00 의 기울어짐·가라앉음).
    spawn_reject_pocket: tuple = (0.135, 0.0, 0.035)
