"""grasp_ua 보상 — grasp_v1 8항 이식 + 이송 2항(transfer·stay) 신설.
...
항 계약(`GRASP_UA_REWARD_TERMS`)은 **이 트랙 로컬**이다 —
...
GRASP_UA_REWARD_TERMS: tuple[str, ...] = (
    "approach",
    "enclosure",
    "finger_closure",
    "grasp",
...
def compute_grasp_ua_rewards(
    *,
    ...
    _missing = set(GRASP_UA_REWARD_TERMS) - set(terms)
    if _missing:
