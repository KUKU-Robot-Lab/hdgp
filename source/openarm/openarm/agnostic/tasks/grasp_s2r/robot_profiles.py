...
TESOLLO_RIGHT_SHORT = _dc_replace(
    ...
    #     닿으므로 한계 여유가 11.88° → 17.90° 로 늘었다. 어댑터 전 값은
    #     (0.0455, 0.0328, 0.4357, 0.7708, −0.2991, 0.3203, 0.7864) 였다.
    arm_reset_joint_pos=(-0.0330, 0.1378, 0.1625, 0.8157, -0.0097, 0.2097, 0.7680),
    init_joint_pos={
