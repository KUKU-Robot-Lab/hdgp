...
# ★★09.10 포크 — 이 파일은 `tasks/grasp_s2r/grasp_s2r_env_cfg.py` 의 사본이다(포크 시점 0fa2159b).
#   사용자 확정: "s2r 하고 fj 는 앞으로 공유 금지". 트랙 B(grasp_fj)가 s2r 의 과제
#   정의를 상속하고 있어서, 다른 세션이 base 를 고치면 fj 가 조용히 따라갔다 —
