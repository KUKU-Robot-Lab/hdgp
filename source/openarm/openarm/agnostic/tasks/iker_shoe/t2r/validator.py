"""Validation of generated stage-1 reward code (IKER t2r fork) — static check + fake RewardContext dry run, no Isaac.
...
NUM_FINGERS, NUM_LINKS, NUM_HAND, NUM_ARM, NUM_ACTIONS = 5, 3, 20, 7, 26
