...
class _FakeCtx:
    def __init__(self, value: float = 1.0):
        self.placed = self.released = self.resting = self.still = self.home = self.retracting = torch.tensor([value > 0])
