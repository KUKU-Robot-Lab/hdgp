...
#   scripts/experiments/run_pour_t2r.sh <label> <iter_dir> [--num_envs N] [추가 train 인자...]
#   예) CUDA_VISIBLE_DEVICES=1 scripts/experiments/run_pour_t2r.sh t2r_i00 reward_gen/pour_bi/iter_00 --num_envs 256
